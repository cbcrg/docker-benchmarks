...
# each instance executes 9 tasks 
native_mean_task_time = native_mean_exec_time / 9
docker_mean_task_time = docker_mean_exec_time / 9

cat(sprintf("RNA-SEQ         : native  docker\n"))
